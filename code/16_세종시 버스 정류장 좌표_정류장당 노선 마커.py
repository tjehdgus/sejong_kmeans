...
light_pink = '#ffb6c1'
gmap.scatter(latitudes, longitudes, color=light_pink, size=10, marker=False)

output_file = "c:\\data\\bus_stop_filtered_map_pink_google.html"
gmap.draw(output_file)

webbrowser.open(output_file)
print("Google 지도에 필터링된 정류장이 연한 분홍색 점으로 표시된 파일이 생성되고 브라우저에서 열렸습니다.")
