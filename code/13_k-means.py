...
# 첫 번째 데이터 (파란색, 지하철역, 버스정류장, 횡단보도)
for i, row in independent_data_filtered.iterrows():
    folium.CircleMarker(location=[row['lat'], row['lng']], radius=3, color='blue', fill=True, fill_color='blue', fill_opacity=0.6).add_to(mymap)
